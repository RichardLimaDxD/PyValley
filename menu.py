...
class Menu:
    def __init__(self, player, toggle_menu):
        ...
        self.font = pygame.font.Font("./setup/font/LycheeSoda.ttf", 30)
    ...
    def setup(self):
        ...
        self.total_height += (len(self.text_surfs) - 1) * self.scape
    ...
    def update(self):
        ...
        for text_index, text_surf in enumerate(self.text_surfs):
            top = self.main_rect.top + text_index * (
                text_surf.get_height() + (self.padding * 2) + self.scape
            )
