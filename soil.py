...
class Plant(pygame.sprite.Sprite):
    def __init__(self, plant_type, groups, soil, check_watered):
        ...
        self.frames = import_folder(f"./setup/graphics/fruit/{plant_type}")
        self.soil = soil
...
class SoilLayer:
    def __init__(self, all_sprites, collision_sprites):
        ...
        self.soil_surfs = import_folder_dict("./setup/graphics/soil/")
        self.water_surfs = import_folder("./setup/graphics/soil_water")

        self.create_soil_grid()
        self.create_hit_rects()

        self.hoe_sound = pygame.mixer.Sound("./setup/audio/hoe.wav")
        self.hoe_sound.set_volume(0.1)

        self.plant_sound = pygame.mixer.Sound("./setup/audio/plant.wav")
        self.plant_sound.set_volume(0.2)

    def create_soil_grid(self):
        ground = pygame.image.load("./setup/graphics/world/ground.png")
        h_tiles, v_tiles = (
        ...
        for x, y, _ in (
            load_pygame("./setup/data/map.tmx").get_layer_by_name("Farmable").tiles()
        ):
